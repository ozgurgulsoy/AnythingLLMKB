...
{
    /// <summary>
    /// Önbellek işlemleri için yardımcı extension metotları.
    /// </summary>
    public static class CacheExtensions
    {
        ...
        /// <summary>
        /// Belirli bir tipe ve isteğe bağlı öneke göre önbellek anahtarı oluşturur.
        /// </summary>
        /// <typeparam name="T">Anahtar için kullanılacak tip</typeparam>
        /// <param name="prefix">İsteğe bağlı önek</param>
        /// <returns>Önbellek anahtarı</returns>
